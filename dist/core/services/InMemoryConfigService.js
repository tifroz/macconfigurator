...
class InMemoryConfigServiceImpl {
    store;
...
export const InMemoryConfigServiceLayer = Layer.effect(ConfigStorageService, Effect.gen(function* () {
...
//# sourceMappingURL=InMemoryConfigService.js.map